...
openApiGenerate {
    val openapiGroup = "${rootProject.group}.users.api.v1"
...
docker {
    springBootApplication {
        ...
        images.set(listOf("ilyabikmetov/microservice-user:$version"))
...
tasks.jar {
    manifest {
        attributes["Main-Class"] = "ru.ibikmetov.microservices.UsersApplication"
    }
}
